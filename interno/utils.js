...
const AYUDA_ITEMS = {
    'dashboard.html':        { titulo: 'Dashboard', resumen: 'Resumen general del complejo. Muestra KPIs de reservas, tareas urgentes, ingresos del mes y posición bancaria. También permite sincronizar el calendario de Airbnb.', seccion: 'dashboard' },
    'calendario.html':       { titulo: 'Calendario', resumen: 'Vista mensual de todas las reservas por cabaña. Los bloques de color indican ocupación. Tocá un día para ver el detalle o crear una reserva.', seccion: 'calendario' },
    'reservas.html':         { titulo: 'Reservas', resumen: 'Gestión completa de reservas directas y de Airbnb. Podés confirmar, editar fechas, registrar pagos y crear tareas de limpieza asociadas.', seccion: 'reservas' },
    'presupuestos.html':     { titulo: 'Presupuestos', resumen: 'Crea y envía presupuestos a potenciales huéspedes. El sistema calcula el precio automáticamente según tarifas y temporada.', seccion: 'reservas' },
    'clientes.html':         { titulo: 'Clientes', resumen: 'Directorio de huéspedes con historial de reservas. Se completa automáticamente al confirmar una reserva.', seccion: 'reservas' },
    'panel-financiero.html': { titulo: 'Panel Financiero', resumen: 'Vista consolidada de todas las cuentas con balance por período. Elegí rango de fechas y verás ingresos, egresos, retiros y flujo neto por cuenta. También muestra movimientos sin conciliar y gastos sin comprobante.', seccion: 'finanzas' },
    'pagos.html':            { titulo: 'Ingresos y Egresos', resumen: 'Registrá cobros a huéspedes, gastos operativos con foto de comprobante, retiros personales y honorarios. Los gastos se clasifican por circuito: fiscal (Casa Verde), personal o mixto.', seccion: 'finanzas' },
    'informes-airbnb.html':  { titulo: 'Informes Airbnb', resumen: 'Importá los PDFs de liquidación de Airbnb. La IA extrae automáticamente los datos de cada reserva, comisiones y monto neto depositado.', seccion: 'finanzas' },
    'cuentas.html':          { titulo: 'Cuentas', resumen: 'Administración de cuentas bancarias (BTG Mauro, BTG Flor y otras). Muestra saldo actual y permite actualizar manualmente.', seccion: 'finanzas' },
    'movimientos.html':      { titulo: 'Movimientos', resumen: 'Extracto completo de movimientos importados desde el banco. Podés categorizar, filtrar y buscar. Los movimientos sin conciliar aparecen destacados.', seccion: 'finanzas' },
    'herramientas-btg.html': { titulo: 'BTG / Conciliación', resumen: 'Herramienta para importar extractos bancarios, auto-conciliar movimientos contra registros del sistema, categorizar y depurar duplicados. El flujo es: Importar → Auto-conciliar → Categorizar.', seccion: 'finanzas' },
    'categorias.html':       { titulo: 'Categorías', resumen: 'Define y edita las categorías de movimientos bancarios. Se usan en la pestaña Categorizar de Herramientas BTG.', seccion: 'finanzas' },
    'tareas.html':           { titulo: 'Tareas', resumen: 'Vista operativa para colaboradores. Mostrá las tareas asignadas, iniciá el cronómetro al comenzar y finalizá cuando terminés. El sistema calcula horas y genera el honorario automáticamente.', seccion: 'tareas' },
    'tareas-admin.html':     { titulo: 'Gestión de Tareas', resumen: 'Vista administrativa: creá tareas, asignales prioridad y fecha, revisá el historial de quién hizo qué y cuántas horas trabajó. Los honorarios se generan automáticamente al finalizar una tarea.', seccion: 'tareas' },
    'pendientes.html':       { titulo: 'Pendientes', resumen: 'Lista de recordatorios y tareas sin cronómetro. El semáforo de colores indica urgencia: rojo urgente, amarillo atención, verde normal. Podés asignar cada pendiente a una persona.', seccion: 'pendientes' },
    'fiscal.html':           { titulo: 'Panel Fiscal', resumen: 'Control de obligaciones fiscales en Brasil. Calculá el Carnê-Leão mensual, registrá pagos de DARF, usá el simulador de escenarios y gestioná el acceso de la contadora.', seccion: 'fiscal' },
    'acceso-contador.html':  { titulo: 'Acceso Contador', resumen: 'Generá un link temporal para que la contadora acceda a los datos fiscales sin necesidad de usuario. El link vence automáticamente según el plazo que elijas.', seccion: 'fiscal' },
    'cabanas-admin.html':    { titulo: 'Cabañas', resumen: 'Configuración de las tres unidades: fotos, descripción en 3 idiomas, amenities, tarifas por temporada y vinculación con Google Calendar de Airbnb.', seccion: 'cabanas' },
    'usuarios.html':         { titulo: 'Usuarios', resumen: 'Gestión de accesos al sistema. Dos roles: Admin (acceso completo) y Colaborador (solo ve sus tareas y cobros). Podés activar o desactivar usuarios sin borrarlos.', seccion: 'usuarios' },
    'manual-sistema.html':   { titulo: 'Manual del sistema', resumen: 'Documentación completa de todas las funciones. El admin puede editar el contenido directamente desde esta pantalla.', seccion: null },
};
...
async function mostrarAyuda(pagina) {
    ...
    document.getElementById('_ayudaTitulo').textContent  = info.titulo;
